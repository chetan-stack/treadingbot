...
nifty_50_stocks = [
    'ADANIENT-EQ', 'ASIANPAINT-EQ', 'AXISBANK-EQ', 'BAJAJFINSV-EQ', 'BAJFINANCE-EQ',
    'BHARTIARTL-EQ', 'BPCL-EQ', 'BRITANNIA-EQ', 'CIPLA-EQ', 'COALINDIA-EQ',
    'DIVISLAB-EQ', 'DRREDDY-EQ', 'EICHERMOT-EQ', 'GRASIM-EQ', 'HCLTECH-EQ',
    'HDFCBANK-EQ', 'HDFCLIFE-EQ', 'HEROMOTOCO-EQ', 'HINDALCO-EQ', 'HINDUNILVR-EQ',
    'HDFC-EQ', 'ICICIBANK-EQ', 'INFY-EQ', 'INDUSINDBK-EQ', 'JSWSTEEL-EQ',
    'KOTAKBANK-EQ', 'M&M-EQ', 'MARUTI-EQ', 'NTPC-EQ', 'NESTLEIND-EQ',
    'ONGC-EQ', 'POWERGRID-EQ', 'RELIANCE-EQ', 'SBILIFE-EQ', 'SBIN-EQ',
    'SUNPHARMA-EQ', 'TCS-EQ', 'TATACONSUM-EQ', 'TATAMOTORS-EQ', 'TATASTEEL-EQ',
    'TECHM-EQ', 'TITAN-EQ', 'UPL-EQ', 'ULTRACEMCO-EQ', 'WIPRO-EQ'
]
